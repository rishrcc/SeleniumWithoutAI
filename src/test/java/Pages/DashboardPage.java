...
public class DashboardPage
{
    ...
    public static String submenuGestionDesFormateurs = "//a[normalize-space()='Gestion des formateurs']"; //xpath
    ...
    public static String btnListOfPersonneMorale = "/html/body/queoval-root/ng-component/div[2]/div[1]/header/nav[1]/div[1]/div/button[1]"; //xpath
    ...
    public static String btnRegister = "//*[@id=\"boL1\"]/div[1]/button[4]/i";//"(//button[normalize-space()='Enregistrer'])[1]"; //xpath
}
